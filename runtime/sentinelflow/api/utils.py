...
VISIBLE_RUNTIME_OVERRIDE_KEYS = {
    ...
    "llm_model", "llm_temperature", "llm_timeout", "llm_thinking_adapter_enabled",
    "weekly_alert_cleanup_enabled", "run_log_retention_days", "full_report_format_skill", "alert_source_enabled",
